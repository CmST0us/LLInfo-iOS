//
//  SchoolIdolTomotachiApiHelper.swift
//  LLInfo
//
...
final class SchoolIdolTomotachiApiHelper {
    //MARK: - Private Member
    ...
    static let shared = SchoolIdolTomotachiApiHelper()
    //api base url
...
extension SchoolIdolTomotachiApiHelper {
