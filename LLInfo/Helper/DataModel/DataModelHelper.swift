...
class DataModelHelper {
    ...
    func payloadDictionaries(withJsonData data:Data) -> [Dictionary<String, Any>]? {
        return trySyntaxAsDictionary(withJsonData: data, key: "payload") as? [Dictionary<String, Any>]
    }
    func success(withJsonData data: Data) -> Bool? {
        return trySyntaxAsDictionary(withJsonData: data, key: "success") as? Bool
    }
    
    func message(withJsonData data: Data) -> String? {
        return trySyntaxAsDictionary(withJsonData: data, key: "message") as? String
    }
